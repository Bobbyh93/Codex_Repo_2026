...
- Pilot Evidence Export: use JSON for audit data, Markdown for director briefs, and printable HTML for faculty/program-director review packets; each export carries linked Drive deck exemplars plus audit-pattern references for premium review and traceability.
