...
- Educator item import validation against the item metadata contract
...
- `test/item-validation.test.mjs`: item contract and import validation regression checks.
...
- Added educator item import validation for IDs, blueprint category, clinical judgment step, concepts, lesson links, difficulty, format, options, scoring, rationales, misconception tags, and source evidence.

## Next Engineering Slice

1. Add authenticated educator item authoring, import persistence, and review workflow.
